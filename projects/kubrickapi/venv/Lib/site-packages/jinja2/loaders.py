...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'add_person.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/add_person.html'`` the file from the app1 package is loaded,
    by loading ``'app2/add_person.html'`` the file from the second.
    """
